...
contract ProtectedTransparentUpgradeableSubProxyTest is Test, CFUtils {
    ProtectedTransparentUpgradeableSubProxy public proxy_contract;
    ...
    function setUp() public virtual {
        ...
        proxy_contract = new ProtectedTransparentUpgradeableSubProxy(address(costumer_contract), proxy_admin, "");
